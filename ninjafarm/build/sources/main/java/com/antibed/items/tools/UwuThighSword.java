...
public class UwuThighSword extends ItemSword implements IHasModel {

    public UwuThighSword(String name, ToolMaterial material){
        super(material);
    ...
    public void addInformation(ItemStack p_addInformation_1_, @Nullable World p_addInformation_2_, List<String> p_addInformation_3_, ITooltipFlag p_addInformation_4_) {
        ...
        p_addInformation_3_.add("With our powers combined, we are unstoppable");
    }
