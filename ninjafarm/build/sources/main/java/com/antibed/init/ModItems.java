...
import com.antibed.items.ItemBase;
import com.antibed.items.armor.ArmorBase;
import com.antibed.items.crops.FoodBase;
import com.antibed.items.crops.ItemRice;
import com.antibed.items.tools.ThighSword;
import com.antibed.items.tools.ToolStaff;
import com.antibed.items.tools.ToolSword;
import com.antibed.items.tools.UwuThighSword;
...
public class ModItems {
    ...
    public static final Item THIGH_SWORD = new ThighSword("thigh_sword", ModMaterials.MATERIAL_THICC_THIGHS);
    public static final Item UWU_THIGH_SWORD = new UwuThighSword("uwu_thigh_sword", ModMaterials.MATERIAL_UWU_THIGHS);
