...
public class ContainerIncenseCondenser extends Container {
    private final TileEntityIncenseCondenser tileentity;
    private int cookTime, totalCookTime, burnTime, currentBurnTime;
    private ItemStackHandler handler = new ItemStackHandler(4);

    public ContainerIncenseCondenser(InventoryPlayer player, TileEntityIncenseCondenser tileentity)
    {
        ...
        if(slot != null && slot.getHasStack())
        {
            ...
            else if(index != 2 && index != 1 && index != 0)
            {
                ...
                if(!IncenseCondenserRecipes.getInstance().getIncenseResult(stack1, slot1.getStack()).isEmpty())
                {
                    ...
                    else if(TileEntityIncenseCondenser.isItemFuel(stack1))
                    {
