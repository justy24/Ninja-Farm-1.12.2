...
public class TileEntityIncenseCondenser extends TileEntity implements ITickable
{
    ...
    public static boolean isBurning(TileEntityIncenseCondenser te) {
    ...
    public void update() {
        if(this.isBurning()) {
            --this.burnTime;
            BlockIncenseCondenser.setState(true, world, pos);
        }
